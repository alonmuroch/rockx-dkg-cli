...
// Hash: 50732170092a8b55c06006c0f8d4c90ce768dfe1ff1e14fcd6fb642a471d7822
package node
...
func (k *KyberMessage) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (e *Exchange) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
